...
direction_2_negate <- function(x) {
  .Call(`_euclid_direction_2_negate`, x)
}

direction_2_less <- function(x, y) {
  .Call(`_euclid_direction_2_less`, x, y)
}

direction_2_greater <- function(x, y) {
  .Call(`_euclid_direction_2_greater`, x, y)
}

direction_2_sort <- function(x, decreasing, na_last) {
  .Call(`_euclid_direction_2_sort`, x, decreasing, na_last)
}

direction_2_rank <- function(x) {
  .Call(`_euclid_direction_2_rank`, x)
}

direction_2_min <- function(x, na_rm) {
  .Call(`_euclid_direction_2_min`, x, na_rm)
}

direction_2_max <- function(x, na_rm) {
  .Call(`_euclid_direction_2_max`, x, na_rm)
}

direction_2_cummin <- function(x) {
  .Call(`_euclid_direction_2_cummin`, x)
}

direction_2_cummax <- function(x) {
  .Call(`_euclid_direction_2_cummax`, x)
}

direction_2_between <- function(x, d1, d2) {
  .Call(`_euclid_direction_2_between`, x, d1, d2)
}
...
direction_3_negate <- function(x) {
  .Call(`_euclid_direction_3_negate`, x)
}

geometry_squared_distance <- function(geo1, geo2) {
  .Call(`_euclid_geometry_squared_distance`, geo1, geo2)
}

geometry_distance_matrix <- function(geo1, geo2) {
  .Call(`_euclid_geometry_distance_matrix`, geo1, geo2)
}
...
geometry_primitive_type <- function(geometries) {
  .Call(`_euclid_geometry_primitive_type`, geometries)
}
...
geometry_approx_length <- function(geometries) {
  .Call(`_euclid_geometry_approx_length`, geometries)
}

geometry_approx_area <- function(geometries) {
  .Call(`_euclid_geometry_approx_area`, geometries)
}

geometry_approx_volume <- function(geometries) {
  .Call(`_euclid_geometry_approx_volume`, geometries)
}
...
geometry_has_point_inside <- function(geometries, points) {
  .Call(`_euclid_geometry_has_point_inside`, geometries, points)
}

geometry_has_point_on <- function(geometries, points) {
  .Call(`_euclid_geometry_has_point_on`, geometries, points)
}

geometry_has_point_outside <- function(geometries, points) {
  .Call(`_euclid_geometry_has_point_outside`, geometries, points)
}

geometry_has_point_on_positive <- function(geometries, points) {
  .Call(`_euclid_geometry_has_point_on_positive`, geometries, points)
}

geometry_has_point_on_negative <- function(geometries, points) {
  .Call(`_euclid_geometry_has_point_on_negative`, geometries, points)
}

geometry_constant_in <- function(geometries, coord) {
  .Call(`_euclid_geometry_constant_in`, geometries, coord)
}

geometry_parallel <- function(geo1, geo2) {
  .Call(`_euclid_geometry_parallel`, geo1, geo2)
}

geometry_project_to_line <- function(geometries, lines) {
  .Call(`_euclid_geometry_project_to_line`, geometries, lines)
}

geometry_project_to_plane <- function(geometries, planes) {
  .Call(`_euclid_geometry_project_to_plane`, geometries, planes)
}

geometry_map_to_plane <- function(geometries, planes) {
  .Call(`_euclid_geometry_map_to_plane`, geometries, planes)
}

geometry_normal <- function(geometries) {
  .Call(`_euclid_geometry_normal`, geometries)
}

geometry_intersection <- function(geo1, geo2) {
  .Call(`_euclid_geometry_intersection`, geo1, geo2)
}

geometry_do_intersect <- function(geo1, geo2) {
  .Call(`_euclid_geometry_do_intersect`, geo1, geo2)
}
...
create_iso_cube_minmax <- function(minx, miny, minz, maxx, maxy, maxz) {
  .Call(`_euclid_create_iso_cube_minmax`, minx, miny, minz, maxx, maxy, maxz)
}
...
create_iso_rect_minmax <- function(minx, miny, maxx, maxy) {
  .Call(`_euclid_create_iso_rect_minmax`, minx, miny, maxx, maxy)
}
...
geometry_barycenter_2 <- function(p1, p2) {
  .Call(`_euclid_geometry_barycenter_2`, p1, p2)
}

geometry_barycenter_3 <- function(p1, p2, p3) {
  .Call(`_euclid_geometry_barycenter_3`, p1, p2, p3)
}

geometry_barycenter_4 <- function(p1, p2, p3, p4) {
  .Call(`_euclid_geometry_barycenter_4`, p1, p2, p3, p4)
}

geometry_bisector <- function(geo1, geo2) {
  .Call(`_euclid_geometry_bisector`, geo1, geo2)
}

geometry_centroid_1 <- function(geo) {
  .Call(`_euclid_geometry_centroid_1`, geo)
}

geometry_centroid_3 <- function(p1, p2, p3) {
  .Call(`_euclid_geometry_centroid_3`, p1, p2, p3)
}

geometry_centroid_4 <- function(p1, p2, p3, p4) {
  .Call(`_euclid_geometry_centroid_4`, p1, p2, p3, p4)
}

geometry_equidistant_line <- function(p1, p2, p3) {
  .Call(`_euclid_geometry_equidistant_line`, p1, p2, p3)
}

geometry_radical_geometry <- function(geo1, geo2) {
  .Call(`_euclid_geometry_radical_geometry`, geo1, geo2)
}
...
point_collinear <- function(x, y, z) {
  .Call(`_euclid_point_collinear`, x, y, z)
}

point_coplanar <- function(x, y, z, t) {
  .Call(`_euclid_point_coplanar`, x, y, z, t)
}

point_ordered <- function(x, y, z) {
  .Call(`_euclid_point_ordered`, x, y, z)
}

point_ordered_along <- function(x) {
  .Call(`_euclid_point_ordered_along`, x)
}

point_turns_left <- function(x, y, z) {
  .Call(`_euclid_point_turns_left`, x, y, z)
}

point_turns_right <- function(x, y, z) {
  .Call(`_euclid_point_turns_right`, x, y, z)
}
...
create_vector_2_direction <- function(d) {
  .Call(`_euclid_create_vector_2_direction`, d)
}
...
create_vector_3_direction <- function(d) {
  .Call(`_euclid_create_vector_3_direction`, d)
}
